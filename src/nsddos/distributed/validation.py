...
def validate_distributed_evaluation(
    ...
    if (
        evaluation.leader_state.primary_node
        and evaluation.leader_state.primary_node == evaluation.leader_state.standby_node
    ):
    ...
    worker_types = [
        assignment.worker_type for assignment in evaluation.worker_assignments
    ]
    ...
    if (
        evaluation.failover_available
        and not evaluation.failover_state.leader_failover_node
    ):
